...
String channelId = "YOUR_CHANNELID";
String readApiKey = "YOUR_TS_API_KEY";

// TinyGsmClient sim800l
#define APN "YOURAPNHERE"
#define SIM800_RX 10             //TX to PIN 10 at Microcontroller
#define SIM800_TX 11             //RX to PIN 11 at Microcontroller
int PIN_BUZZER = A5;
